<script lang="ts">
  import { products, search, selectedColumn } from "../../store/products";
...
<form class="FilterBarWrap">
  <div class="CustomSearchbar">
    ...
    <input
      ...
      type="search"
      placeholder="Search"
      on:input={(e) => handleSearchChange(e)}
    />
  </div>
  <div class="FormWrap">
    <div>
      <input
        ...
        on:change={(e) => selectedColumn(e.currentTarget.value)}
      />
